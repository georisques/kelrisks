            ...
            <template v-if="avis.ppr && avis.ppr.length > 0">
                <div class="container bordered ppr"
                    ...
                    <div>
                        ...
                        <p>Rappel du risque : {{ plan.alea.familleAlea.libelle }}{{ (plan.dateApprobation ? ', PPR approuvé le ' + formatDate(plan.dateApprobation) : ', PPR prescrit le ' + formatDate(plan.datePrescription)) }}.</p>
