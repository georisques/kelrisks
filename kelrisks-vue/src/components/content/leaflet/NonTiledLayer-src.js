...
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})},{}],2:[function(require,module,exports){
(function (global){
/*
...
L.NonTiledLayer = (L.Layer || L.Class).extend({
	...
	_initCanvas: function () {
		...
		// FIXME : sinon erreur oops, something went wrong! DOMException: The operation is insecure.
		_canvas._image.crossOrigin = 'anonymous';
	...
	_animateImage: function (image, e) {
		if (typeof L.DomUtil.setTransform === 'undefined') {  // Leaflet 0.7
			...
			var map = this._map, scale = image._scale * image._sscale * map.getZoomScale(e.zoom), nw = image._bounds.getNorthWest(), se = image._bounds.getSouthEast(), topLeft = map._latLngToNewLayerPoint(nw, e.zoom, e.center);
