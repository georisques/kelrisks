...
public class ParcelleQO extends AbstractQO {
    ...
    private List<PrefSecNumInsee> parcelles = new ArrayList<>();
    ...
    public void feedBuilder(BooleanBuilder builder) {
        ...
        if (prefixe != null) {builder.and(QParcelle.parcelle.prefixe.equalsIgnoreCase(prefixe));}
        ...
        if (parcelles != null && !parcelles.isEmpty()) {
            ...
            parcelles.forEach(secNumInsee -> {
                ...
                secAndNumBuilder.and(QParcelle.parcelle.prefixe.equalsIgnoreCase(secNumInsee.prefixe));
    ...
    @Data
    public static class PrefSecNumInsee {
        ...
        public PrefSecNumInsee(String prefixe, String section, String numero, String insee) {
