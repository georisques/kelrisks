...
public class CommuneService extends AbstractCRUDService<Commune> implements ICommuneService {
    ...
    @Override
    public List<Commune> rechercherCommunesLimitrophes(String codeINSEE) {
        
        return dao.rechercherCommunesLimitrophes(codeINSEE);
    }

	@Override
	public Commune rechercherCommuneAvecCodeINSEE(String codeINSEE) {
		if(StringUtils.isNotBlank(codeINSEE)) {
		    return dao.rechercherCommuneAvecCodeINSEE(codeINSEE);
		}
		return null;
	}
}
